...
- Reference design: [ESP32-S3-DevKitC-1](https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp32-s3-devkitc-1/index.html)
- Pinning:
  - LED matrix 32x8
...
- Manufacturer: [Lilygo](https://lilygo.cc/products/t-display?srsltid=AfmBOoqYRjCX8MV0n_o-94-pFiF6-dUzS7QKkgV3mP2jYdcxx3uaqSSq)
- Pinning:
...
- Pinning:
  - Variant: 32x8
    ...
    - Display: [display:lilygo_tdisplay-s3-32x8](../../config/display.ini)
  - Variant: 64x16
    - Board: [board:lilygo-t-display-s3-TFT-64x16](../../config/board.ini)
    - Display: [display:lilygo_tdisplay-s3-64x16](../../config/display.ini)
- Not compatible with Pixelix boards.
